...
class SessionController extends Controller{
  ...
  function validateSession(){
      ...
      if($this->existsSession()){
          ...
          error_log("sessionController::validateSession(): identificacion:" . $this->user->getVid() . " - role: " . $this->user->getRol());
          if($this->isPublic()){
  ...
  function getUserSessionData(){
      ...
      $this->user->get($id);
      error_log("sessionController::getUserSessionData(): " . $this->user->getVid());
      return $this->user;
  }

  public function initialize($user){
      error_log("sessionController::initialize(): user: " . $user->getVid());
